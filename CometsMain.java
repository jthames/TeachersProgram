...
public class CometsMain implements KeyListener
{
	...
	public void paint(Graphics g){
		...
		g.drawImage(sprite, 400, 400, null);
	}
	
	
	// This tests the spriteSheet functionality
	public void intit(){
		BufferedImageLoader loader = new BufferedImageLoader();
		BufferedImage spriteSheet = null;
		
		try {
			spriteSheet = loader.loadImage("spriteSheet2.png");
		} catch (IOException e) {
		...
		sprite = ss.gradSprite(0, 0, 134, 250);
		
	}
	
	public static void main(String[] args)
	{
		CometsMain cm = new CometsMain();
